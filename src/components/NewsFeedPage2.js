...
const NewsFeedPage = () => {
    ...
    const { NewsFeedPage2Id } = useParams();
   ...
   useEffect(() => {
    ...
    useEffect(() => {
        ...
        db.collection("database").doc("9dNSb95MI7bCaiGqnbPe").collection("news").doc(NewsFeedPage2Id).onSnapshot(snap=>
